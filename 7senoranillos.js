...
const configVida = prompt("Configura puntos de vida de los jugadores");

alert("La vida introducida es de " + configVida);

function Personaje(nombre, configVida){

    this.nombre = nombre;
    this.vida = configVida;
    this.sp = 100;
...
var personaje1 = new Personaje("Gandalf",configVida);
var personaje2 = new Personaje("Legolas",configVida);
